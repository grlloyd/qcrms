...
\newpage
```{r RT, echo=F, message=FALSE, warning=FALSE, cache=FALSE, comment="", strip.white=TRUE}
#if (!is.null(QCreportObject$QC_label)){
  print(kable (QCreportObject$tables$RT_rsd, digits=2))
#}
```

```{r RT_2, echo=FALSE, message=FALSE, warning=FALSE, comment="", cache=FALSE, results='hide', fig.width=7, fig.height=6, prompt=FALSE}
#if (!is.null(QCreportObject$QC_label)){
...
\newpage
```{r RT_3, echo=F, message=FALSE, warning=FALSE, cache=FALSE, comment="", strip.white=TRUE}
#if (!is.null(QCreportObject$QC_label)){
  print(kable (QCreportObject$tables$peak_width, digits=2))
#}
```

```{r RT_4, echo=FALSE, message=FALSE, warning=FALSE, comment="", cache=FALSE, results='hide', fig.width=7, fig.height=6, prompt=FALSE}
#if (!is.null(QCreportObject$QC_label)){
  print (QCreportObject$plots$peak_width_RSD)
#}
```
