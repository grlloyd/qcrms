...
<!-- RT stability -->
* RSD% of RT 
```{r RT_RSD_table, echo=F, message=FALSE, warning=FALSE, cache=FALSE, comment=""}
#if (!is.null(QCreportObject$QC_label)){
  ...
  print(kable (QCreportObject$tables$RT_rsd, digits=c(rep(2,6),0)))
#}
```
...
```{r RT_MAD_table, echo=F, message=FALSE, warning=FALSE, cache=FALSE, comment=""}
#if (!is.null(QCreportObject$QC_label)){
...
* Summary of median peak width per feature (s)
```{r RT_PW_median, echo=F, message=FALSE, warning=FALSE, cache=FALSE, comment="", strip.white=TRUE}
#if (!is.null(QCreportObject$QC_label)){
  print(kable (QCreportObject$tables$peak_width, digits=2))
#}
```

&nbsp;
&nbsp;
* Summary of all peak widths (s) per sample group 
```{r RT_PW_all, echo=F, message=FALSE, warning=FALSE, cache=FALSE, comment="", strip.white=TRUE}
#if (!is.null(QCreportObject$QC_label)){
  print(kable (QCreportObject$tables$peak_width_all, digits=2))
#}
```

\newpage
```{r RT_PW_plot_median, echo=FALSE, message=FALSE, warning=FALSE, comment="", cache=FALSE, results='hide', fig.width=7, fig.height=9, prompt=FALSE}
#if (!is.null(QCreportObject$QC_label)){
...
* Deviation of mz in ppm from mean mz of the feature, median per feature
```{r mz_ppm, echo=F, message=FALSE, warning=FALSE, cache=FALSE, comment="", strip.white=TRUE}
#if (!is.null(QCreportObject$QC_label)){
  print(kable (QCreportObject$tables$mz_median, digits=2))
#}
```
&nbsp;
&nbsp;
* Deviation of mz in ppm from mean mz of the feature, all ppm value per sample group
```{r mz_ppm_all, echo=F, message=FALSE, warning=FALSE, cache=FALSE, comment="", strip.white=TRUE}
#if (!is.null(QCreportObject$QC_label)){
  print(kable (QCreportObject$tables$mz_all, digits=2))
#}
```

\newpage
```{r mz, echo=FALSE, message=FALSE, warning=FALSE, comment="", cache=FALSE, results='hide', fig.width=7, fig.height=9, prompt=FALSE}
#if (!is.null(QCreportObject$QC_label)){
