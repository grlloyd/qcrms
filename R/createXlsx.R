...
createXlsx <- function (QCreportObject)
{
  ...
  # If it xcms can handle original file names, and after all files have been processed.
  # Where is tracability to the original files if this has been done to the outputs?
  ...
  {
    addWorksheet (wb, "variableMetaData")
    variableMetaData = rowMeans(QCreportObject$peakMatrix, na.rm = TRUE, dims = 1)
